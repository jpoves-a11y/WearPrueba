...
- **Volumetric Wear Calculation**: Integrates the volume between the fitted sphere and the real worn surface within the detected worn zone using tetrahedral decomposition.
...
- **Python Version**: 3.11 (installed via modules)
...
```
.
├── index.html              # Main application (~4075 lines, standalone)
...
The application is fully operational in the Replit environment and ready for use and deployment.